...
Revision ID: c137571c05c3
Revises: 44678b139018
Create Date: 2021-03-23 21:35:57.965255
...
revision = 'c137571c05c3'
down_revision = '44678b139018'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('desc_seeking', sa.String(length=200), nullable=True),
    ...
    sa.Column('desc_looking', sa.String(length=200), nullable=True),
    sa.Column('genres', sa.ARRAY(sa.String()), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    sa.Column('desc_looking', sa.VARCHAR(length=200), autoincrement=False, nullable=True),
    sa.Column('genres', postgresql.ARRAY(sa.VARCHAR()), autoincrement=False, nullable=True),
    sa.Column('talent_looking', sa.BOOLEAN(), autoincrement=False, nullable=True),
    ...
    sa.Column('image_link', sa.VARCHAR(length=500), autoincrement=False, nullable=True),
    sa.Column('facebook_link', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('desc_seeking', sa.VARCHAR(length=200), autoincrement=False, nullable=True),
    sa.Column('talent_seeking', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('website_link', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
